  ...
  return (
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <Text style={{...registerStyles.userTypeLabel, fontSize:14}}>Facultad:</Text>
        <CustomPicker
        ...
        <Text style={{...registerStyles.userTypeLabel, fontSize:14}}>Programa:</Text>
        <CustomPicker
          defaultValue="Seleccione una programa"
          selectedValue={selectedProgram}
          setSelectedValue={setProgramId}
          values={[...currentPrograms, { _id: "default", name: "Todas", id: "default" }]}
          isPrimary={false}
        />

        <Text style={{...registerStyles.userTypeLabel, fontSize:14}}>Tipo de evento:</Text>
        <CustomPicker
